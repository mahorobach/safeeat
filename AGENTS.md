...
| ルール | 理由 |
|---|---|
| `web/` から Codex / Gemini API を直接呼ばない | APIキー漏洩防止 |
...
- 設計相談・バグ調査はCodex Chatを活用する
- Codex Chatは必ずファイルを確認してから判断する
...
- Codex Chatでの変更内容は、セッション終了時に.mdファイルへ反映する
